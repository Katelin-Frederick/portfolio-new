...
const Contact = () => {
  ...
  return (
    <section id='ContactMe' className='mb-24 px-7'>
      ...
      <Form {...form}>
        <form name='contact-form' onSubmit={form.handleSubmit(onSubmit)} className='space-y-8 flex flex-col items-center mt-12'>
